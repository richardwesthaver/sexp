...
#S(MACS.RT::TEST-RESULT
   :TAG :PASS
   :FORM #S(MACS.RT::TEST-RESULT
            :TAG :PASS
            :FORM (SXP:WRITE-SXP-STREAM SXP-TESTS::F NIL))) 
#S(MACS.RT::TEST-RESULT
   :TAG :PASS
   :FORM #S(MACS.RT::TEST-RESULT
            :TAG :PASS
            :FORM (STRINGP (SXP:WRITE-SXP-STRING SXP-TESTS::F)))) 
#S(MACS.RT::TEST-RESULT
   :TAG :PASS
   :FORM #S(MACS.RT::TEST-RESULT
            :TAG :PASS
            :FORM (EQUAL (SXP:UNWRAP SXP-TESTS::F) (SXP:UNWRAP SXP-TESTS::F)))) 
#S(MACS.RT::TEST-RESULT
   :TAG :PASS
   :FORM #S(MACS.RT::TEST-RESULT :TAG :PASS :FORM (SXP:FORMP T))) 
No tests failed.
#+end_example
